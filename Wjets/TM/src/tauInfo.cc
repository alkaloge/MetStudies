...
void tauInfo::Fill(const edm::Event& iEvent, math::XYZPoint& pv, reco::Vertex& vtx){
  ...
  edm::View<pat::Tau>::const_iterator tau;
	...
	if(fabs(pv.z()-tau->vertex().z()) < 0.0001){
		dxy = tau->dxy();
	}
	else{
		dxy = dxy_approx;
	...
	Tau_pvDiff.push_back((float) fabs(pv.z()-tau->vertex().z()));
...
*/
	Tau_byVVVLooseDeepTau2017v2p1VSjet.push_back((float) tau->tauID("byVVVLooseDeepTau2017v2p1VSjet"));	
	Tau_byVVLooseDeepTau2017v2p1VSjet.push_back((float) tau->tauID("byVVLooseDeepTau2017v2p1VSjet"));	
	Tau_byVLooseDeepTau2017v2p1VSjet.push_back((float) tau->tauID("byVLooseDeepTau2017v2p1VSjet"));	
	Tau_byLooseDeepTau2017v2p1VSjet.push_back((float) tau->tauID("byLooseDeepTau2017v2p1VSjet"));	
	Tau_byMediumDeepTau2017v2p1VSjet.push_back((float) tau->tauID("byMediumDeepTau2017v2p1VSjet"));	
	Tau_byTightDeepTau2017v2p1VSjet.push_back((float) tau->tauID("byTightDeepTau2017v2p1VSjet"));	
	Tau_byVTightDeepTau2017v2p1VSjet.push_back((float) tau->tauID("byVTightDeepTau2017v2p1VSjet"));	
	Tau_byVVTightDeepTau2017v2p1VSjet.push_back((float) tau->tauID("byVVTightDeepTau2017v2p1VSjet"));	

	Tau_byVLooseDeepTau2017v2p1VSmu.push_back((float) tau->tauID("byVLooseDeepTau2017v2p1VSmu"));	
	Tau_byLooseDeepTau2017v2p1VSmu.push_back((float) tau->tauID("byLooseDeepTau2017v2p1VSmu"));	
	Tau_byMediumDeepTau2017v2p1VSmu.push_back((float) tau->tauID("byMediumDeepTau2017v2p1VSmu"));	
	Tau_byTightDeepTau2017v2p1VSmu.push_back((float) tau->tauID("byTightDeepTau2017v2p1VSmu"));	

	Tau_byVVVLooseDeepTau2017v2p1VSe.push_back((float) tau->tauID("byVVVLooseDeepTau2017v2p1VSe"));	
	Tau_byVVLooseDeepTau2017v2p1VSe.push_back((float) tau->tauID("byVVLooseDeepTau2017v2p1VSe"));	
	Tau_byVLooseDeepTau2017v2p1VSe.push_back((float) tau->tauID("byVLooseDeepTau2017v2p1VSe"));	
	Tau_byLooseDeepTau2017v2p1VSe.push_back((float) tau->tauID("byLooseDeepTau2017v2p1VSe"));	
	Tau_byMediumDeepTau2017v2p1VSe.push_back((float) tau->tauID("byMediumDeepTau2017v2p1VSe"));	
	Tau_byTightDeepTau2017v2p1VSe.push_back((float) tau->tauID("byTightDeepTau2017v2p1VSe"));	
	Tau_byVTightDeepTau2017v2p1VSe.push_back((float) tau->tauID("byVTightDeepTau2017v2p1VSe"));	
	Tau_byVVTightDeepTau2017v2p1VSe.push_back((float) tau->tauID("byVVTightDeepTau2017v2p1VSe"));	
