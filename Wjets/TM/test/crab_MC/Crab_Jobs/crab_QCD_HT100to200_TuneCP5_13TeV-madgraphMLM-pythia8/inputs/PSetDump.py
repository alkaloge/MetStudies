...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://cms-xrd-global.cern.ch//store/mc/RunIIAutumn18MiniAOD/QCD_HT100to200_TuneCP5_13TeV-madgraphMLM-pythia8/MINIAODSIM/102X_upgrade2018_realistic_v15-v1/20000/362B457C-213F-EE49-92B3-28063639CBBA.root')
)
...
process.p = cms.Path(process.egammaPostRecoSeq+process.ecalBadCalibReducedMINIAODFilter+process.patJetCorrFactorsUpdatedJEC+process.updatedPatJetsUpdatedJEC+process.selectedUpdatedPatJetsUpdatedJEC+process.fullPatMetSequence+process.puppiMETSequence+process.fullPatMetSequencePuppi+process.demo)
