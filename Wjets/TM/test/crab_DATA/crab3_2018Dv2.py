...
config.General.requestName = 'SingleMuon2018Dv2'
...
config.JobType.psetName = '/afs/cern.ch/work/p/pdas/METstudies/performance/CMSSW_10_2_15/src/TreeMaker/TM/test/treemaker_cfg_data2018_prompt.py'
