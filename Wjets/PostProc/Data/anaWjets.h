...
// Files and histograms
   ...
   TFile *fileName;
   TTree *mettree;
   Float_t uparallel, uperpendicular, met, met_phi,  corrmet, corrmet_phi, jet_pt, jet_eta, jet_phi, IDSF, lepton_pt, lepton_eta, lepton_phi, lepton_energy, corrupara, corruperp;
   Float_t nvsf;
   Bool_t fail;
   Int_t nvtx, nJet;
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   anaWjets(string fileToOpen, const char* file2);
   virtual ~anaWjets();
...
#ifdef anaWjets_cxx
anaWjets::anaWjets(string fileToOpen, const char* file2) 
{
...
Int_t anaWjets::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t anaWjets::LoadTree(Long64_t entry)
{
...
void anaWjets::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("PFJet_DeepCSVb", &PFJet_DeepCSVb, &b_PFJet_DeepCSVb);
...
void anaWjets::Show(Long64_t entry)
{
...
Int_t anaWjets::Cut(Long64_t entry)
{
